  ...
  return (
    <div className="full_height_no_scroll flex flex-col justify-center">
      <div className='mx-auto flex flex-col items-center'>
        ...
        <div className='p-2 border-2 border-primary text-center text-[0.8rem] sm:text-[1rem] lg:text-[1.5rem] animate-fade-down animate-once animate-delay-[200ms] animate-ease-in-out'><p>LET'S <TypingEffect words={['CREATE.', 'CODE.', 'BUILD.', 'DESIGN.', 'DEVELOP.']}/></p><p>HIGHLY EFFECTIVE SOLUTIONS FOR REAL WORLD PROBLEMS</p></div>
